...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}llccc@{}}
    ...
    \textbf{Task} & \textbf{Encoding} & \textbf{Detection} & \textbf{False alarm} &
      $\phi$ \\
    \midrule
    \texttt{connected\_nodes} & \texttt{incident}   & 0.327 & 0.102 & $+0.186$ \\
    \texttt{connected\_nodes} & \texttt{adjacency}  & 0.423 & 0.201 & $+0.217$ \\
    \texttt{connected\_nodes} & \texttt{friendship} & 0.308 & 0.085 & $+0.288$ \\
    \addlinespace
    \texttt{node\_degree} & \texttt{incident}   & 0.260 & 0.070 & $+0.185$ \\
    \texttt{node\_degree} & \texttt{adjacency}  & 0.298 & 0.102 & $+0.218$ \\
    \texttt{node\_degree} & \texttt{friendship} & 0.208 & 0.059 & $+0.208$ \\
    \addlinespace
    \texttt{edge\_existence} & \texttt{incident}   & 0.857 & 0.105 & $+0.406$ \\
    \texttt{edge\_existence} & \texttt{adjacency}  & 0.957 & 0.290 & $+0.537$ \\
    \texttt{edge\_existence} & \texttt{friendship} & 0.926 & 0.161 & $+0.694$ \\
    \midrule
...
(cells share graphs); values below $0.001$ are shown as \texttt{<0.001}. Detection
