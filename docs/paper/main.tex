...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}llcccc@{}}
    ...
    \textbf{Task} & \textbf{Encoding} & \textbf{Baseline} & \textbf{Turn 1} &
      \textbf{Debate} & \textbf{Vote} \\
    \midrule
    \texttt{connected\_nodes} & \texttt{incident}   & 0.958 & 0.947 & 0.940 & 0.952 \\
    \texttt{connected\_nodes} & \texttt{adjacency}  & 0.743 & 0.835 & 0.817 & 0.822 \\
    \texttt{connected\_nodes} & \texttt{friendship} & 0.488 & 0.655 & 0.687 & 0.687 \\
    \addlinespace
    \texttt{node\_degree} & \texttt{incident}   & 0.873 & 0.942 & 0.935 & 0.943 \\
    \texttt{node\_degree} & \texttt{adjacency}  & 0.655 & 0.868 & 0.850 & 0.875 \\
    \texttt{node\_degree} & \texttt{friendship} & 0.637 & 0.828 & 0.828 & 0.837 \\
    \addlinespace
    \texttt{edge\_existence} & \texttt{incident}   & 0.980 & 0.978 & 0.975 & 0.985 \\
    \texttt{edge\_existence} & \texttt{adjacency}  & 0.938 & 0.922 & 0.803 & 0.950 \\
    \texttt{edge\_existence} & \texttt{friendship} & 0.867 & 0.800 & 0.752 & 0.822 \\
    \bottomrule
  \end{tabular}
...
behind the pooled figures in \S\ref{sec:results}. Detection
