...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}[font=\sffamily, flow/.style={opacity=0.35}]
    ...
    % bottom summary row
    \def\yL{-1.35}\def\yV{-2.1}
    \draw[black!25] (4.9,-0.9) -- (4.9,-2.35);
    \draw[black!25] (9.1,-0.9) -- (9.1,-2.35);
    \node[text=black!55, font=\sffamily\small] at (2.3,\yL) {INITIAL ERROR RATE};
    \node[font=\sffamily\Large] at (2.3,\yV) {13.6\%};
    \node[text=black!55, font=\sffamily\small] at (7.0,\yL) {FINAL ERROR RATE};
    \node[font=\sffamily\Large] at (7.0,\yV) {15.7\%};
    \node[text=black!55, font=\sffamily\small] at (11.7,\yL) {NET CHANGE};
    \node[font=\sffamily\Large, text=cFinalW!80!black] at (11.7,\yV) {+2.1\%};
  \end{tikzpicture}}
...
Llama-3.3-70B is here, five right for every one wrong - revision puts more correct
...
entirely the reasoning it introdduces: in most of our testing the verify-and-revise loop was harmful,
...
right$\to$wrong, so a positive value means the loop helped that cell.
